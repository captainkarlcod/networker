 ...
 */
function csco_canvas_register_layout_wide_type_3( $layouts = array() ) {
	...
	$layouts[ $layout ] = array(
		...
		'name'        => esc_html__( 'Wide 3', 'networker' ),
		'template'    => get_template_directory() . "/template-parts/blocks/{$layout}.php",
		'icon'        => '<svg fill="none" height="44" viewBox="0 0 52 44" width="52" xmlns="http://www.w3.org/2000/svg"><g stroke="#000"><rect height="42" rx="2" stroke-width="1.5" width="50" x="1" y="1"/><path d="m5 5h10" stroke-linecap="round" stroke-linejoin="round"/><path d="m26 5h10" stroke-linecap="round" stroke-linejoin="round"/><path d="m5 25h7" stroke-linecap="round" stroke-linejoin="round"/><path d="m26 25h7" stroke-linecap="round" stroke-linejoin="round"/><path d="m5 27h12" stroke-linecap="round" stroke-linejoin="round"/><path d="m48 24-2 2 2 2" stroke-linecap="round" stroke-linejoin="round"/><path d="m46 20 2-2-2-2" stroke-linecap="round" stroke-linejoin="round"/><path d="m26 27h12" stroke-linecap="round" stroke-linejoin="round"/><path d="m5 29h7" stroke-linecap="round" stroke-linejoin="round"/><path d="m26 29h7" stroke-linecap="round" stroke-linejoin="round"/><path d="m22 1v32" stroke-width="1.5"/><path d="m43 1v32" stroke-width="1.5"/><path d="m51 33h-50" stroke-width="1.5"/></g><circle cx="10" cy="38" fill="#000" r="1"/><circle cx="14" cy="38" fill="#000" r="1"/><circle cx="6" cy="38" r="1" stroke="#000"/></svg>',
		'sections'    => array(
			'general'    => array(
...
add_filter( 'canvas_block_layouts_canvas/posts', 'csco_canvas_register_layout_wide_type_3' );
