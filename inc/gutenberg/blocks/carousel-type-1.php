 ...
 */
function csco_canvas_register_layout_carousel_type_1( $layouts = array() ) {

	$layout = 'carousel-type-1';

	// Add new layout.
	$layouts[ $layout ] = array(
		'location'    => array(),
		'name'        => esc_html__( 'Carousel', 'networker' ),
...
add_filter( 'canvas_block_layouts_canvas/posts', 'csco_canvas_register_layout_carousel_type_1' );
