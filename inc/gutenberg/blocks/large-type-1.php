...
function csco_canvas_register_layout_large_type_1( $layouts = array() ) {
	...
	$layouts[ $layout ] = array(
		...
		'name'        => esc_html__( 'Large 1', 'networker' ),
		'template'    => get_template_directory() . "/template-parts/blocks/{$layout}.php",
		'icon'        => '<svg fill="none" height="44" viewBox="0 0 52 44" width="52" xmlns="http://www.w3.org/2000/svg"><g stroke="#000"><rect height="42" rx="2" stroke-width="1.5" width="50" x="1" y="1"/><path d="m5 21h12" stroke-linecap="round" stroke-linejoin="round"/><path d="m5 5h7" stroke-linecap="round" stroke-linejoin="round"/><path d="m5 25h17" stroke-linecap="round" stroke-linejoin="round"/><path d="m5 27h17" stroke-linecap="round" stroke-linejoin="round"/><path d="m41 35-2 2 2 2" stroke-linecap="round" stroke-linejoin="round"/><path d="m45 39 2-2-2-2" stroke-linecap="round" stroke-linejoin="round"/><path d="m5 23h26" stroke-linecap="round" stroke-linejoin="round"/><path d="m43 1v30" stroke-width="1.5"/><path d="m51 31h-50" stroke-width="1.5"/></g><circle cx="10" cy="38" fill="#000" r="1"/><circle cx="14" cy="38" fill="#000" r="1"/><circle cx="6" cy="38" r="1" stroke="#000"/></svg>',
		'sections'    => array(
			'general'    => array(
