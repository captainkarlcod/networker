<?php
/**
 * The template for displaying the header 2
 *
 * @package Networker
 */
...
<header class="cs-header cs-header-stretch cs-header-two" <?php echo wp_kses( $scheme, 'post' ); ?>>
	<div class="cs-container">
		<div class="cs-header__inner cs-header__inner-desktop">
			...
			<div class="cs-header__col cs-col-center">
				<?php csco_component( 'header_search_form' ); ?>
			</div>
