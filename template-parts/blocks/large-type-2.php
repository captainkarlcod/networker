...
if ( $posts->have_posts() ) { ?>
	<div class="<?php echo esc_attr( $attributes['className'] ); ?>">
		<div class="cnvs-block-posts-inner">
			<div class="cs-slider cs-flickity-init" data-autoplay="<?php echo esc_attr( $options['autoplay'] ); ?>" data-pagedots="<?php echo esc_attr( $options['pagedots'] ); ?>" data-wraparound="<?php echo esc_attr( $options['wraparound'] ); ?>" data-groupcells="<?php echo esc_attr( $options['groupcells'] ); ?>">
